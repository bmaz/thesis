...
\begin{center}
	\input{tables/July/number_articles_negbinomial_cevent_heterogeneity_nb_journalist_accounts.tex}
\end{center}
\begin{spacing}{0.5}
...
\begin{center}
	\input{tables/July/number_articles_negbinomial_cevent_socialmediapresence.tex}
\end{center}
\begin{spacing}{0.5}
...
\begin{center}
	\input{tables/July/number_articles_negbinomial_cevent_RFrench.tex}
\end{center}
\begin{spacing}{0.5}
...
\begin{center}
	\input{tables/July/number_articles_negbinomial_event_RControls.tex}
\end{center}
\begin{spacing}{0.5}
...
\begin{center}
	\input{tables/July/regression_event_IV_Poisson_GMM_RControls.tex}
\end{center}
\begin{spacing}{0.5}
...
\begin{center}
	\input{tables/July/regression_event_IV_Poisson_GMM_RDropSmallEvents.tex}
\end{center}
\begin{spacing}{0.5}
...
\begin{center}
	\input{tables/July/regression_media_IV_Poisson_GMM_R90articles.tex}
\end{center}
\begin{spacing}{0.5}
